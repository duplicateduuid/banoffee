<script lang="ts">
	...
	const { redirect, name, description, author, className }: Props = $props();
</script>

<a href={redirect} class={classNames("flex gap-4 h-40 shadow px-8 py-6 rounded-lg bg-white", className)}>
